...
func (in *SleepScheduleSpec) DeepCopyInto(out *SleepScheduleSpec) {
	*out = *in
	if in.StandardTime != nil {
		in, out := &in.StandardTime, &out.StandardTime
		*out = new(StandardTime)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StandardTime) DeepCopyInto(out *StandardTime) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StandardTime.
func (in *StandardTime) DeepCopy() *StandardTime {
	if in == nil {
		return nil
	}
	out := new(StandardTime)
